#ifndef TRAACTMULTI_USECASE_IN0IN1_IN2_OUT0_H
#define TRAACTMULTI_USECASE_IN0IN1_IN2_OUT0_H

#include "UseCase_Behaviour.h"

namespace dataflow_use_case_test {
class DATAFLOW_USE_CASE_TEST_EXPORT UseCase_In0In1_In2_Out0 : public UseCase_Behaviour {
 public:
...
#endif //TRAACTMULTI_USECASE_IN0IN1_IN2_OUT0_H
