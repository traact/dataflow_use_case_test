#include "UseCase_In0In1_In2In3_Out0_Out1.h"

namespace dataflow_use_case_test {
UseCaseProblem UseCase_In0In1_In2In3_Out0_Out1::GetProblem() const {
    return UseCaseProblem::In0In1_In2In3_Out0_Out1;
}

size_t UseCase_In0In1_In2In3_Out0_Out1::GetTimeDomainCount() const {
    return 1;
}

void UseCase_In0In1_In2In3_Out0_Out1::CheckInputs(const std::vector<ExpectedSource> &expectedSources,
...
void UseCase_In0In1_In2In3_Out0_Out1::AssignExpectedSources(
...
void UseCase_In0In1_In2In3_Out0_Out1::CreateResult(const std::pair<TimestampType, int> &ts_td,
