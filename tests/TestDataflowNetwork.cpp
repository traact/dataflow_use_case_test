...
void
TestDataflowNetwork::Init(dataflow_use_case_test::UseCaseProblem problem,
    ...
    switch (problem_) {
        ...
        case UseCaseProblem::In0In1_In2In3_Out0_Out1:buffer_.resize(1);
            break;
        case UseCaseProblem::In0In1TD0_In2In3TTD1_Out0TD0_Out1TD0_Buffer:buffer_.resize(2);
            break;
