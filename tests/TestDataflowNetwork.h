...
public:
    void Init(dataflow_use_case_test::UseCaseProblem problem, const dataflow_use_case_test::BaseProblemList &problem_list,
...
private:
    ...
    std::vector<std::map<int, std::pair<dataflow_use_case_test::TimestampType, dataflow_use_case_test::TestDataType>>> buffer_;
